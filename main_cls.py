...
from util import cal_loss, IOStream, FocalLoss, cal_loss_v2
...
def pc_from_h5(file_name):
        f = h5py.File(file_name, "r")

        test_pc = np.asarray(f['pc_data'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=32, metavar='batch_size',
                        help='Size of batch)')#ori=32
    parser.add_argument('--test_batch_size', type=int, default=16, metavar='batch_size',
                        help='Size of batch)')
    parser.add_argument('--epochs', type=int, default=500, metavar='N',
                        help='number of episode to train ')#ori=250
    ...
    parser.add_argument('--emb_dims', type=int, default=512, metavar='N',
                        help='Dimension of embeddings')# ori=1024
