...
![1 -w150](https://github.com/baiyuxas/HDGCN/blob/main/1st.png){:height="30%" width="30%"}

The framework of our model is as follows：
![2 -w150](https://github.com/baiyuxas/HDGCN/blob/main/fig1.png){:height="30%" width="30%"}
