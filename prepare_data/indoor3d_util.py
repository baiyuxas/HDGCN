...
def room2blocks(data, label, num_point, block_size=2.0, stride=1.0,
...
def room2blocks_wrapper(data_label_filename, num_point, block_size=2.0, stride=1.0,
                        random_sample=False, sample_num=None, sample_aug=1):
...
def room2blocks_wrapper_normalized(data_label_filename, num_point, block_size=2.0, stride=1.0,
                                   random_sample=False, sample_num=None, sample_aug=1):
    if data_label_filename[-3:] == 'txt':
        data_label = np.loadtxt(data_label_filename)
    elif data_label_filename[-3:] == 'npy':
